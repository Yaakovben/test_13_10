import {createPost, getPosts, deletePost, updatePost} from "../Controllers/StudentController"
 ...
 */
router.delete("/:id", onlySoldiersAndCommanders, deletePost)
 ...
 *         description: Server error
 */
router.put("/:id", onlySoldiersAndCommanders, updatePost)
